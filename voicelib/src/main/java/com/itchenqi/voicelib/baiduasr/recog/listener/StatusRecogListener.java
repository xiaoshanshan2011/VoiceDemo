package com.itchenqi.voicelib.baiduasr.recog.listener;
...
import com.itchenqi.voicelib.baiduasr.recog.IStatus;
import com.itchenqi.voicelib.baiduasr.recog.RecogResult;
...
public class StatusRecogListener implements IRecogListener, IStatus {
    ...
    public void onAsrFinalResult(String[] results, RecogResult recogResult) {
        status = STATUS_CORRECT_FINISHED;
    }
